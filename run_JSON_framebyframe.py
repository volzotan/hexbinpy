...
BACKGROUND_FILE     = "augustbaudertplatz.jpg"
HEXAGON_SIZE        = 20
...
if __name__ == "__main__":
    ...
    for i in range(0, len(json_files)):
        ...
        index = int(len(hexagon_binsizes)*0.99)
        if index > 0:
            maxval = hexagon_binsizes[index]
        else:
            maxval = 1
        ...
        subprocess.call("/Applications/Inkscape.app/Contents/Resources/bin/inkscape --export-png /Users/volzotan/GIT/hexbinpy/timelapse/output_{}.png /Users/volzotan/GIT/hexbinpy/output.svg".format(i), shell=True)
        subprocess.call("convert /Users/volzotan/GIT/hexbinpy/timelapse/output_{0}.png -resize 720 -quality 40 /Users/volzotan/GIT/hexbinpy/timelapse/output_{0}.png".format(i), shell=True)
